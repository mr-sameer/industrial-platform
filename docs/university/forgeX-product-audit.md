...
| **Trust** | A one-employee general trading company (also selling earphones/LED bulbs) is labeled "Manufacturer" with no verified evidence behind that specific role. | `/company/example-company-d` |
